...
docker run --rm --user 1000:1000 ghcr.io/dobbo-ca/azcopy-move/azcopy:10.32.4 -c 'azcopy --version'
docker run --rm --user 1000:1000 ghcr.io/dobbo-ca/azcopy-move/azcopy:10.32.4 -c 'awk --version | head -1'
docker run --rm --user 1000:1000 ghcr.io/dobbo-ca/azcopy-move/azcopy:10.32.4 -c 'id'
docker run --rm --user 1000:1000 ghcr.io/dobbo-ca/azcopy-move/azcopy:10.32.4 -c \
...
docker run --rm --user 1000:1000 --read-only \
  ...
  ghcr.io/dobbo-ca/azcopy-move/azcopy:10.32.4 -c 'touch /work/x && echo writable-ok'
docker run --rm --user 1000:1000 ghcr.io/dobbo-ca/azcopy-move/azcopy:10.32.4 -c \
...
Rough, uncompressed: Azure Linux base core plus azcopy and gawk lands around
120 MB. The PowerShell version it replaces was roughly 400 MB.
